...
struct DRuleReducer {
	static void createReplacementsFile(const std::string& pmproofsFile = "data/pmproofs.txt", const std::string& outputFile = "data/pmproofs-reducer.txt", const std::string& inputFilePrefix = "data/dProofs-withConclusions/dProofs", bool withConclusions = true, bool debug = false);
