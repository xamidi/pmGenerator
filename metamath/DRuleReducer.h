...
struct DRuleReducer {
	static void createReplacementsFile(const std::string& pmproofsFile = "data/pmproofs.txt", const std::string& outputFile = "data/pmproofs-reducer.txt", bool memReduction = true, bool debug = false);
