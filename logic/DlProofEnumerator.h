...
public:
	...
	static void rebaseProofSummary(const std::string& inputFile, const std::string& baseFile, bool normalPolishNotation = false, bool printInfixUnicode = false, const std::string* outputFile = nullptr, bool targetEverything = false, bool debug = false);
